...
// Scroll container reference (.app-scroll from layout)
...
onMounted(async () => {
    ...
    // Set scroll container to layout's scrollable element
    scrollContainer.value = document.querySelector('.app-scroll');
                    ...
                    <div class="navbar">
                        <div class="container-xl">
                            <div class="d-flex flex-wrap align-items-center gap-2 p-2">
                                ...
                                <div class="flex-fill">
                                    <button class="btn btn-primary btn-sm w-100" @click="openCreate">
