...
<template>
      ...
      <div class="card-header">
        ...
        <div class="card-actions d-flex flex-wrap">
          <div class="input-group input-group-flat w-auto me-2">
            <input v-model="search" type="text" class="form-control form-control-sm" autocomplete="off"
  ...
  <!-- Create Modal -->
  <div class="modal fade" id="modal-create-executor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createExecutorLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="submitCreate" :disabled="createForm.processing || createInvalid">
            Создать
          </button>
        </div>
      </div>
  ...
  <!-- Edit Modal -->
  <div class="modal fade" id="modal-edit-executor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editExecutorLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Delete Modal -->
  <div class="modal fade" id="modal-delete-executor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteExecutorLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="modal-delete-restricted" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteRestrictedLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center py-4">
          <i class="ti ti-alert-triangle icon mb-2 text-warning" style="font-size: 2rem"></i>
