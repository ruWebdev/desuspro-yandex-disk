                ...
                <div class="col-md-auto col-sm-12">
                  <div class="ms-auto d-flex flex-wrap btn-list">
                    <div class="input-group input-group-flat w-auto">
                      ...
                      <input id="advanced-table-search" v-model="searchQuery" type="text" class="form-control" autocomplete="off" placeholder="Поиск по имени или email" />
                      <span class="input-group-text">
                        <kbd>ctrl + K</kbd>
                      </span>
                    </div>
                ...
                <div class="row g-2">
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input v-model="createForm.password" type="text" class="form-control" placeholder="Минимум 8 символов" required />
              ...
              <form @submit.prevent="submitEdit">
                <div class="row g-2">
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input v-model="editForm.password" type="text" class="form-control" placeholder="Оставьте пустым, чтобы не менять" />
