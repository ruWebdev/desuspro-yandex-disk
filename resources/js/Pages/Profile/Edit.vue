              ...
              <form @submit.prevent="submitProfile">
                ...
                <div class="row g-2">
                  <div class="col-12 col-sm-4">
                    ...
                    <input id="last_name" type="text" class="form-control" v-model="profileForm.last_name" autocomplete="family-name" />
                    <div v-if="profileForm.errors.last_name" class="text-danger small mt-1">{{ profileForm.errors.last_name }}</div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <label class="form-label" for="first_name">Имя</label>
                    <input id="first_name" type="text" class="form-control" v-model="profileForm.first_name" autocomplete="given-name" />
                    <div v-if="profileForm.errors.first_name" class="text-danger small mt-1">{{ profileForm.errors.first_name }}</div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <label class="form-label" for="middle_name">Отчество</label>
                    <input id="middle_name" type="text" class="form-control" v-model="profileForm.middle_name" autocomplete="additional-name" />
                    <div v-if="profileForm.errors.middle_name" class="text-danger small mt-1">{{ profileForm.errors.middle_name }}</div>
                  </div>
                </div>

                <div class="mt-3">
                  <label class="form-label" for="email">Email</label>
                  <input id="email" type="email" class="form-control" v-model="profileForm.email" autocomplete="username" />
                ...
                <div v-if="props.mustVerifyEmail && user.email_verified_at === null" class="mt-2">
                  ...
                  <Link :href="route('verification.send')" method="post" as="button" class="btn btn-link px-0">Отправить письмо с подтверждением</Link>
                  <div v-show="props.status === 'verification-link-sent'" class="text-success small">Ссылка отправлена.</div>
                </div>
                ...
                <div class="row mt-4 g-2">
                  <div class="col-12 col-sm-6">
                    ...
                    <span :class="['badge', user.is_blocked ? 'bg-red' : 'bg-green']">{{ user.is_blocked ? 'Заблокирован' : 'Разрешен' }}</span>
                  </div>
                  <div class="col-12 col-sm-6">
            ...
            <div class="card-body">
              <form @submit.prevent="submitPassword">
                <div class="mb-3">
                  ...
                  <input id="current_password" ref="currentPasswordInput" type="password" class="form-control" v-model="passwordForm.current_password" autocomplete="current-password" />
                ...
                <div class="mb-3">
                  ...
                  <input id="password" ref="newPasswordInput" type="password" class="form-control" v-model="passwordForm.password" autocomplete="new-password" />
                ...
                <div class="mb-3">
                  ...
                  <input id="password_confirmation" type="password" class="form-control" v-model="passwordForm.password_confirmation" autocomplete="new-password" />
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input id="delete_password" ref="deletePasswordInput" v-model="deleteForm.password" type="password" class="form-control" placeholder="Пароль" />
                <div v-if="deleteForm.errors.password" class="text-danger small mt-1">{{ deleteForm.errors.password }}</div>
              </div>
